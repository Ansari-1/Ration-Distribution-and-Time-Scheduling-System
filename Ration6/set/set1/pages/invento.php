            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">RDS Inventory</a>
                    </div>
                </div>
            </nav>
            <!-- End Navbar -->
            <div class="content">
                <div class="container-fluid">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><b><?php echo $rows['Available']; ?></td>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating">Add Qty in kgs</label>
                                                    <input name="add_qty" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    if (isset($_POST['set_qty1'])) {
                        ...
                        $sql = "UPDATE ration_items SET Available=Available+'$qty1' WHERE Item_no='$id';";
